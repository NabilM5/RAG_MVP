...
questions = [
    "Какие основные цели развития ИИ определены в Стратегии до 2030 года?",
    "Каким образом Стратегия планирует обеспечить технологический суверенитет в области ИИ?",
    "Почему Стратегия устанавливает целевой объем услуг по разработке и реализации ИИ-решений в 12 млрд рублей к 2030 году?",
    "Какие меры предусмотрены для поддержки фундаментальных научных исследований в области ИИ?",
    "Какова роль государственных корпораций в реализации положений Стратегии?",
    "Как Стратегия решает вопрос дефицита высококвалифицированных кадров в сфере ИИ?",
    "Какие этические принципы использования ИИ зафиксированы в документе?",
    "Каким образом планируется развивать вычислительные мощности (суперкомпьютеры) в России?",
    "Какие показатели эффективности (KPI) установлены для оценки реализации Стратегии?",
    "Какие секторы экономики названы приоритетными для внедрения ИИ-технологий?",
    "Каков механизм мониторинга и корректировки Стратегии?",
    "Как планируется развивать нормативно-правовую базу для снятия барьеров внедрения ИИ?",
    "Какие меры поддержки предусмотрены для малого и среднего бизнеса, внедряющего ИИ?"
]
